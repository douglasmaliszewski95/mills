...
export const SustainabilityJourneyButtons: React.FC<
  SustainabilityJourneyButtonsProps
> = (props) => {
  const { cards = [], title, ods = [], link } = props;
  ...
  return (
    <section className="relative">
      ...
      <Section containerClass="tablet:px-4 tablet:py-6 py-10">
        <h3 className="font-semibold text-2xl tablet:text-base w-[40%] tablet:w-full text-green-800">
          {title}
        </h3>
          ...
          {cards?.map(
            (card: SustainabilityJourneyButtonsCardProps, index: number) => (
              ...
              >
                ...
                <h3 className="font-semibold ml-6 tablet:ml-0 tablet:text-sm w-[45%] tablet:w-[65%] text-left">
                  {card.title}
                </h3>
              </button>
            )
        ...
        >
          <div className="bg-white w-[80%] tablet:w-[90%] tablet:h-[98%] rounded-xl">
            ...
            >
              <div className="flex items-center">
                <img
                  ...
                  className="tablet:w-[24px] w-[63px] h-[46px] tablet:h-[19.03px]"
                />
              ...
              <button
                className="border-0 text-black float-right text-3xl leading-none font-semibold outline-none tablet:flex tablet:h-full tablet:pt-6 focus:outline-none"
                onClick={() => setIsOpenModal(false)}
              >
            ...
            <div className="relative px-10 tablet:px-6 pt-4 tablet:pt-0 flex-auto bg-white text-base text-green-800">
              <h3 className="font-semibold tablet:text-sm tablet:my-4">
              ...
              <div>
                <h3 className="py-4 text-green-800 font-semibold tablet:text-sm tablet:py-4 text-base">
              ...
              {/* ODS */}
              <div>
                <h3 className="text-green-800 font-semibold tablet:text-sm text-base mb-2 mt-2">
                  ODS
                </h3>
