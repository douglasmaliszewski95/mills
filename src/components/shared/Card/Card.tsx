...
export const Card: React.FC<CardProps> = (props) => {
  ...
  return (
    <button
      className="w-[159px] flex flex-col flex-1 gap-6 text-orange-500  items-center justify-center py-10 px-9 rounded bg-beige-100 h-[180px] tablet:flex-row hover:bg-orange-500 hover:text-white tablet:py-6 tablet:px-6 tablet:w-full"
